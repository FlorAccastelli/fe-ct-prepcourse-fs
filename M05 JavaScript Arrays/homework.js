...
function multiplicarArgumentos() {
   ...
   return Array.from(arguments).reduce((multiplicacion, argument) => multiplicacion * argument, 1);
   } else return 0;
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var mayorQue18 = array.filter((num) => num > 18);
...
function mayorACien(array) {
   ...
   // Tu código:
   var nuevoArr = array.filter((num) => num > 100);
         return nuevoArr;
}
